 ...
 * タスク新規作成フォームのスキーマ
 */
export const TaskNewFormSchema = z.object({
 ...
 * タスク新規作成フォームの型
 */
export type TaskNewFormData = z.infer<typeof TaskNewFormSchema>;

/**
 * タスクアイテムの型
 */
export type TaskItem = TaskNewFormData["taskItems"][0];
